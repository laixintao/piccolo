...
type Distribution struct {
	...
	Group     string    `gorm:"size:16;uniqueIndex:uniq_idx_group_key_holder_uniq,priority:1" json:"group"`
...
type Host struct {
	ID        uint      `gorm:"primaryKey;autoIncrement" json:"id"`
	HostAddr  string    `gorm:"size:24;uniqueIndex:uniq_idx_group_host,priority:2" json:"host_addr"`
	Group     string    `gorm:"size:16;uniqueIndex:uniq_idx_group_host,priority:1" json:"group"`
